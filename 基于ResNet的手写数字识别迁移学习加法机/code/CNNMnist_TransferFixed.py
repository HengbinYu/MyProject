# 该文件为使用CNN进行手写数字加法器的模型与训练脚本代码，模式为固定值迁移学习
...
FigPath='D:\\work\\PythonProject\\DeepLearning\\Study\\手写数字识别\\06_Transfer Learning\\figs\\CNN_TransferFixed\\'
FilePath='D:\\work\\PythonProject\\DeepLearning\\Study\\手写数字识别\\06_Transfer Learning\\results\\Result_CNN_TransferFixed.xlsx'
...
with pd.ExcelWriter(FilePath) as writer:
    for fraction in fractions:
        ...
        SaveFigPath=FigPath+'CNN_TransferFixed_fraction_{}'.format(fraction)+'.png'
