# 该文件为使用CNN进行手写数字加法器的模型与训练脚本代码，模式为无迁移学习
...
FigPath='D:\\work\\PythonProject\\DeepLearning\\Study\\手写数字识别\\06_Transfer Learning\\figs\\CNN_NoTransfer\\'
FilePath='D:\\work\\PythonProject\\DeepLearning\\Study\\手写数字识别\\06_Transfer Learning\\results\\Result_CNN_NoTransfer.xlsx'
...
with pd.ExcelWriter(FilePath) as writer:
    for fraction in fractions:
        ...
        plt.title('CNN_NoTransfer: fraction={} ; Test_right={:.2%}, Time_cost={:.2f}s'.format(fraction,test_right_ratio,time_cost))
        SaveFigPath=FigPath+'CNN_NoTransfer_fraction_{}'.format(fraction)+'.png'
